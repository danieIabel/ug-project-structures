 ...
 * @author ABEL
 */
public class PanelListaDoble extends javax.swing.JPanel {
    ...
    private void renderNodos() {
        ...
        while (actual != null) {
            ...
            String ligaSiguiente = actual.siguiente != null ? actual.siguiente.toString() : "null";
            String ligaAnterior = actual.anterior != null ? actual.anterior.toString() : "null";

            PanelNodoDoble nodoPanel = new PanelNodoDoble(actual.informacion, ligaAnterior, ligaSiguiente, idActual);
    ...
    private void initComponents() {
        ...
        pageTitle.setText("Listas Doblemente Enlazadas");
        ...
        titleSeccion.setText("Algoritmos Doblemente Enlazadas");
