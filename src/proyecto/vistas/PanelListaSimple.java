 ...
 * @author ABEL
 */
public class PanelListaSimple extends javax.swing.JPanel {
    ...
    private void renderNodos() {
        ...
        while (actual != null) {
            ...
            if (actual.enlace != null) {
                ...
                flecha.setFont(new Font("SansSerif", Font.BOLD, 18));
    ...
    private void initComponents() {
        ...
        pageTitle.setText("Listas Simplemente Enlazadas");
    ...
    private void activarIngresos(boolean activar) {
        String texto = activar ? "Ingrese valor a insertar" : "No disponible";
    ...
    private void selecionarAlgoritmoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_selecionarAlgoritmoItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            ...
            switch (seleccion) {
                ...
                case "Eliminar al inicio" -> activarIngresos(false);
                case "Eliminar al final" -> activarIngresos(false);
