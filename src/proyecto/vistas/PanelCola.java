...
public class PanelCola extends javax.swing.JPanel {
    ...
    private void renderNodos() {
        ...
        while (actual != null) {
            ...
            nodoPanel.setColorInfo(new Color(8, 145, 178));
            nodoPanel.setColorLiga(new Color(14, 116, 144));
            nodoPanel.setColorPuntero(new Color(22, 78, 99));
    ...
    private void renderArreglo() {
        ...
        if (arreglo != null) {
            ...
            for (String pila1 : arreglo) {
                ...
                panelArreglo.setColorInfo(new Color(8, 145, 178));
                Panel.lockSize(panelArreglo);
    ...
    private void initComponents() {
        ...
        pageTitle.setText("Cola (FIFO)");
        jPanel1.add(pageTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, -1, -1));

        visorLista.setBackground(new java.awt.Color(255, 255, 255));
        ...
        visorPanel.setBackground(new java.awt.Color(236, 254, 255));
        ...
        titleSeccion.setText("Algoritmos Cola con Lista");
        ...
        botonPop.setText("Desencolar (Dequeue)");
        ...
        botonPush.setText("Encolar (Enqueue)");
        ...
        tabsTipo.addTab("Cola con Lista", tabLista);
        ...
        botonPopArreglo.setText("Desencolar (Dequeue)");
        ...
        botonPushArreglo.setText("Encolar (Enqueue)");
        ...
        tabsTipo.addTab("Cola con Arreglo", tabArreglo);
    ...
    private void mostrarListaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mostrarListaActionPerformed
        ...
        String texto = "La Cola tiene: " + datos;
        Aviso.warn(texto);
    ...
    private void botonPopArregloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPopArregloActionPerformed
        // TODO add your handling code here:
        if (contador <= 0) {
            Aviso.colaVacia(contador);
            return;
        }
        
        Arreglo.eliminarPrimero(contador, arreglo);
        contador--;
        renderArreglo();
        nuevoValorArreglo.setText("");
        nuevoValorArreglo.requestFocus();
    ...
    private void tabsTipoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tabsTipoStateChanged
        ...
        if (tabsTipo.getSelectedIndex() == 0) {
            ...
            titleSeccion.setText("Algoritmos Cola con Arreglo");
            nuevoValorArreglo.requestFocus();
            arregloActivo = true;
            renderArreglo();
        }
